...
class AuthControllerIT extends AbstractIntegrationTest {
    ...
    @Test
    void register_should_return_201_with_token() throws Exception {
    ...
    @Test
    void login_should_return_200_with_token_after_register() throws Exception {
        mockMvc.perform(post("/api/v1/auth/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                            {
    ...
    @Test
    void login_should_return_409_for_invalid_credentials() throws Exception {
        mockMvc.perform(post("/api/v1/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                            {
